    ...
    <div className="min-h-[70vh] flex items-center justify-center">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Join the Smart Krishi Sahayak platform</p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <a href="#" className="text-xs text-center text-gray-500 uppercase">or sign up with</a>
          <span className="border-b w-1/5 lg:w-1/4"></span>
        </div>
        ...
        <p className="text-center mt-6 text-gray-600">
          Already have an account? <Link to="/login" className="text-gov-primary font-medium hover:underline">Log In</Link>
        </p>
      </div>
    </div>
  );
